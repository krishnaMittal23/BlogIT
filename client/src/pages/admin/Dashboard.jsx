  ...
  return (
    <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
        <div className='flex flex-wrap gap-4'>
            <div className='flex items-center gap-4 bg-white p-4 rounded-lg shadow-md min-w-58 cursor-pointer hover:scale-105 transition-all '>
        ...
        <div>
            <div className='flex items-center gap-3 mt-8 m-4 text-gray-600'>
             ...
             <div className='relative max-w-4xl overflow-x-auto shadow rounded-lg scrollbar-hide bg-white'>
                    <table className='w-full text-sm text-gray-500'>
                        <thead className='text-xs to-gray-600 text-left uppercase'>
                            <tr>
